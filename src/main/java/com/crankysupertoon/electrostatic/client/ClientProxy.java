...
import com.crankysupertoon.electrostatic.CommonProxy;
import com.crankysupertoon.electrostatic.Electrostatic;
import com.crankysupertoon.electrostatic.client.book.BookTransformerAppendModifiers;
...
public class ClientProxy extends CommonProxy {
    ...
    public void registerModel(Item item, int meta, String name) {
        modelsToRegister.add(Triple.of(item, meta, new ModelResourceLocation(Electrostatic.MOD_PREF + name, "inventory")));
    }
